...
$query=mysqli_query($con, "insert into tblusers(FirstName, LastName, Class, MobileNumber, Email, Address,ProfilePic) value('$fname','$lname', '$Class', '$contno', '$email', '$add','$imgnewfile' )");
if ($query) {
